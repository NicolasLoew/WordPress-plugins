...
Description: This Plugin enables you to host Fontawesome v4 locally to better comply with GDPR standards. No legal advice.
...
/* Start Adding Functions Below this Line */
 ...
 /* Register and add local Fontawesome Stylesheet v4 Web
 ...
 */
function add_fonts() {
	wp_register_style('all', plugin_dir_url( __FILE__ ) . 'css/font-awesome.min.css');
